...
plt.plot(np.repeat(y.mean(axis=0).max(),len(rewards_sft)),linewidth=5,ls='dashed')


plt.xlabel('Rounds (models were updated every 50 rounds)', size=20)
plt.ylabel('Cummulative Mean Reward', size=20)
...
plt.savefig("loc_7_2.png", bbox_inches='tight')
...
df.to_csv("rewards_loc7.csv", index=False)