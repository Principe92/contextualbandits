...
df = pandas.read_csv('rewards_loc4.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 4')
...
plt.savefig("location_4.png", bbox_inches='tight', dpi = 600)
