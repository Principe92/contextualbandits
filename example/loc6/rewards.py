...
df = pandas.read_csv('rewards_loc6.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 6')
...
plt.savefig("location_6.png", bbox_inches='tight', dpi = 600)
