...
df = pandas.read_csv('rewards_loc12.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 12')
...
plt.savefig("location_12.png", bbox_inches='tight', dpi = 600)
