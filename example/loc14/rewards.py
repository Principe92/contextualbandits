...
df = pandas.read_csv('rewards_loc14.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 14')
...
plt.savefig("location_14.png", bbox_inches='tight', dpi = 600)
