...
df = pandas.read_csv('rewards_loc15.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 15')
...
plt.savefig("location_15.png", bbox_inches='tight', dpi = 600)
