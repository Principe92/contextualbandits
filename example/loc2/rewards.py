...
df = pandas.read_csv('rewards_loc2.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 2')
...
plt.savefig("location_2.png", bbox_inches='tight', dpi = 600)
