...
df = pandas.read_csv('rewards_loc17.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 17')
...
plt.savefig("location_17.png", bbox_inches='tight', dpi = 600)
