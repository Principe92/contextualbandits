...
plt.figure()
plt.errorbar(x1, y1, yerr=h_y1, markevery=150, linewidth=linewidth, markersize=markersize,marker="X",label='Bootstrapped UCB')
#plt.errorbar(x2, y2, label='Bootstrapped Thompson Sampling')
#plt.errorbar(x3, y3, label='Separate Classifiers + Beta Prior')
plt.errorbar(x4, y4, yerr=h_y4,  markevery=250,linewidth=linewidth, markersize=markersize, marker="<",label='Epsilon-Greedy')
...
plt.errorbar(x7, y7, yerr= h_y7, markevery=400,linewidth=linewidth, markersize=markersize, marker="s",label='Adaptive Greedy')
plt.errorbar(x8, y8, yerr= h_y8,  markevery=250,linewidth=linewidth, markersize=markersize,marker="D",label='Explore First')
plt.errorbar(x9, y9, yerr= h_y9, markevery=150, linewidth=linewidth, markersize=markersize, marker="o", label='Active Explorer')
plt.errorbar(x10, y10, yerr= h_y10,  markevery=200,linewidth=linewidth, markersize=markersize, marker="P",label='Adaptive Active Greedy')
...
#ax.set_xlim(0,3000)
#ax.set_xticks(np.arange(0, 5000, step=500))
...
#plt.xlim(0,4000)
plt.savefig("rewards_oneplot_v9.png", bbox_inches='tight', dpi = 600)
