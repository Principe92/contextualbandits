...
df = pandas.read_csv('rewards_loc9.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 9')
...
plt.savefig("location_9.png", bbox_inches='tight', dpi = 600)
