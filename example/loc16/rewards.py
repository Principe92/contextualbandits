...
df = pandas.read_csv('rewards_loc16.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 16')
...
plt.savefig("location_16.png", bbox_inches='tight', dpi = 600)
