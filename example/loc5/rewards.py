...
df = pandas.read_csv('rewards_loc5.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 5')
...
plt.savefig("location_5.png", bbox_inches='tight', dpi = 600)
