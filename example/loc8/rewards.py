...
df = pandas.read_csv('rewards_loc8.csv')
...
plt.title('Comparison of Online Contextual Bandit Policies in location 8')
...
plt.savefig("location_8.png", bbox_inches='tight', dpi = 600)
